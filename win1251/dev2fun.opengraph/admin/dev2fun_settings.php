			...
			<td colspan="2" align="left">
				<table class="adm-detail-content-table edit-table">
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r">
							<table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_fields_og">
								...
								<tr>
									<td>
										<input type="button" value="<?=Loc::getMessage("LABEL_ADD");?>" onclick="addNewRow('d2f_fields_og')">
									</td>
								</tr>
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r">
							<table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_fields_additional">
								<tbody>
								<? foreach ($ogFieldsAdditional as $key => $field):
									...
									<tr>
										<td>
											<input name="FIELDS_ADDIT[n<?= $key ?>]" value="<?= $field ?>" size="30" type="text" placeholder="<?=Loc::getMessage("LABEL_SETTING_OG_ADDITIONAL_PLACEHOLDER");?>">
										</td>
									</tr>
								<? endforeach; ?>
								...
								<tr>
									<td>
										<input name="FIELDS_ADDIT[n<?=count($ogFieldsAdditional)?>]" value="" size="30" type="text" placeholder="<?=Loc::getMessage("LABEL_SETTING_OG_ADDITIONAL_PLACEHOLDER");?>">
									</td>
									<!--									<td>-->
									<!--										<input name="FIELDS_ADDIT[n--><?//=$cntFieldsAdditional?><!--][value]" value="" size="100" type="text" placeholder="--><?//=Loc::getMessage("LABEL_SETTING_OG_ADDITIONAL_PLACEHOLDER_VALUE");?><!--">-->
									<!--									</td>-->
								</tr>
								<tr>
									<td>
										<input type="button" value="<?=Loc::getMessage("LABEL_ADD");?>" onclick="addNewRow('d2f_fields_additional')">
									</td>
								</tr>
								<script type="text/javascript">
									BX.addCustomEvent('onAutoSaveRestore', function (ob, data) {
					...
					<tr>
						<td class="adm-detail-content-cell-l">
							<table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
								...
								<tr>
									<td>
										<label for="REMOVE_INDEX"><?= Loc::getMessage('LABEL_SETTING_ADD_REMOVE_INDEX') ?></label>
									</td>
								</tr>
								<tr>
									<td>
										<label for="AUTO_ADD_TITLE"><?= Loc::getMessage('LABEL_SETTING_ADD_TITLE') ?></label>
									</td>
								</tr>
								<tr>
									<td>
										<label for="AUTO_ADD_DESCRIPTION"><?= Loc::getMessage('LABEL_SETTING_ADD_DESCRIPTION') ?></label>
									</td>
								</tr>
								<? if(in_array('image',$ogFields)) {?>
									<tr>
										<td>
											<label for="AUTO_ADD_IMAGE"><?= Loc::getMessage('LABEL_SETTING_ADD_IMAGE') ?></label>
										</td>
									</tr>
								<? } ?>
								</tbody>
								...
								<tr>
									<td>
										<div class="sort_container">
											...
											<input type="hidden" value="<?= implode(',', $arSortable) ?>" id="sortableOpenGraph"
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r" colspan="">
							<table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
								...
								<tr>
									<td>
										<input type="checkbox" id="LABEL_SETTING_OG_RESIZE_ENABLE" name="OG_SETTINGS_RESIZE[ENABLE]"
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r" colspan="">
							<table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
								...
								<tr>
									<td>
										<input type="text" id="LABEL_SETTING_OG_RESIZE_WIDTH" name="OG_SETTINGS_RESIZE[WIDTH]"
													 value="<?= isset($arSettingResize['WIDTH']) ? $arSettingResize['WIDTH'] : '' ?>">
									</td>
								</tr>
								<tr>
									<td>
										<input type="text" id="LABEL_SETTING_OG_RESIZE_HEIGHT" name="OG_SETTINGS_RESIZE[HEIGHT]"
									...
									<td>
										...
										<label>
											<input type="radio" name="OG_SETTINGS_RESIZE[TYPE]"
														 value="<?= BX_RESIZE_IMAGE_EXACT ?>" <?= ($arSettingResize['TYPE'] == BX_RESIZE_IMAGE_EXACT) ? 'checked' : '' ?>>
											<?= Loc::getMessage('LABEL_SETTING_OG_BX_RESIZE_IMAGE_EXACT') ?>
										</label><br>
										<label>
											<input type="radio" name="OG_SETTINGS_RESIZE[TYPE]"
														 value="<?= BX_RESIZE_IMAGE_PROPORTIONAL ?>" <?= ($arSettingResize['TYPE'] == BX_RESIZE_IMAGE_PROPORTIONAL) ? 'checked' : '' ?>>
											<?= Loc::getMessage('LABEL_SETTING_OG_BX_RESIZE_IMAGE_PROPORTIONAL') ?>
										</label><br>
										<label>
											<input type="radio" name="OG_SETTINGS_RESIZE[TYPE]"
														 value="<?= BX_RESIZE_IMAGE_PROPORTIONAL_ALT ?>" <?= ($arSettingResize['TYPE'] == BX_RESIZE_IMAGE_PROPORTIONAL_ALT) ? 'checked' : '' ?>>
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r">
							<table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_fields_settings">
								...
								<tr>
									<td>
										<input type="text" name="OGSETTINGS[CACHE_TIME]" value="<?= $settingFields['CACHE_TIME'] ?>"
													 required min="100">
									</td>
								</tr>
								</tbody>
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r">
							<table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_fields_settings">
								...
								<tr>
									<td>
										<input type="submit" class="adm-btn adm-btn-cache-delete" name="CLEAR_CACHE" value="Очистить кэш">
									</td>
								</tr>
								</tbody>
							</table>
